...
#[derive(Clone)]
pub struct FilteredBlockSliceObliv<'a, 'b> {
    ...
    pub full_filter: ArrayView1<'b, Bool>,
}

impl<'a, 'b> FilteredBlockSliceObliv<'a, 'b> {
    pub fn from_block_slice(block_slice: &BlockSlice<'a>, full_filter: &'b [Bool]) -> Self {
        #[cfg(feature = "obliv")]
        ...
        Self {
            ...
            n_unique_states,
            filter,
            full_filter: ArrayView1::from(full_filter),
        }
    }
